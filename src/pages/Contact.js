...
const Contact = () => {
  const contactMethods = [
    ...
    },
    {
      icon: FaEnvelope,
      name: "Email",
      value: "info@learngevity.co.za",
      link: "mailto:info@learngevity.co.za",
          ...
          {contactMethods.map((method, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-4 sm:mb-6 rounded-2xl bg-gradient-to-br ${method.color} flex items-center justify-center shadow-xl transform group-hover:scale-110 transition-transform duration-300`}
                >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            ...
            >
              ...
              <h3 className="font-bold text-white text-lg mb-2 group-hover:text-primary-orange transition-colors">
                Browse Our Tutors
              </h3>
